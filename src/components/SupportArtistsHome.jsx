  ...
  return (
    <div className="containerSupport flex column">
      ...
      <div className="text-sectionSupport">
        ...
        <p className='w80'>Art has always been a popular and stable investment throughout human history. With our diverse selection of artists, you can choose your personal favorites to minimize risk or invest in emerging talents, speculating on their growth and the potential increase in the Artworks values. Each sale contributes 3% to the artists, providing them with crucial support and motivation to advance their careers.</p>
        </div>
      </div>
    </div>
  );
