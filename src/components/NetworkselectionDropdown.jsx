...
const networks = {
  ...
  ethereum: {
    ...
    icon: '/currency-eth.png' // Pfad zum POLYGON Icon
  }
};
...
const NetworkselectionDropdown = ({ onNetworkChange }) => {
  const [selectedNetwork, setSelectedNetwork] = useState(() => {
    ...
    return savedNetwork ? savedNetwork : getCurrentNetwork(); // Verwende den Standardwert, wenn nichts gespeichert ist
  });
  ...
  const getChainIdFromNetwork = (network) => {
    switch (network) {
      ...
      case 'polygon':
        ...
        case 'ethereum':
        return '0xaa36a7'; // Chain ID für Ethereum EVM Testnet
      default:
        return '';
    }
  };
  ...
  return (
    <div className={`network-popup mr15 mb15 ${isDisabled ? 'disabled' : ''}`}>
      <h6 className='mb0 mt0 grey'>TESTNETS</h6>
