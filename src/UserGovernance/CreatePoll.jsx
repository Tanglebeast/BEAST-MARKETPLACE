...
const CreatePoll = ({ onClose }) => {
    ...
    useEffect(() => {
        const checkOwnership = async () => {
            ...
            setIsOwner(accounts[0].toLowerCase() === CONTRACT_OWNER_ADDRESS.toLowerCase());
        };
        checkOwnership();
    }, []);
    ...
    const addPollCreator = async () => {
        ...
        try {
            await contract.methods.addPollCreator(newCreatorAddress).send({
                from: accounts[0],
                gas: 200000,
                gasPrice: '20000000000'
            });
    ...
    const removePollCreator = async () => {
        ...
        try {
            await contract.methods.removePollCreator(removeCreatorAddress).send({
                from: accounts[0],
                gas: 200000,
                gasPrice: '20000000000'
            });
